...
#include "Node.h"
/*
* Stack - This helps build the stack using LinkedList
* Class Properties:
*	head: This is a pointer to the first element in our LinkeList(Stack) - should be of type Node.
*/
template <typename T>
class Stack
{
...
//	}
//	else {
//		std::cout << "Stack is empty. Nothing at the top" << std::endl;
//	}
//}
//
